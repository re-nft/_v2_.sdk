...
interface IWhoopi {
    lend(nftAddress: string, tokenId: BigNumber[], upfrontRentFees: BigNumber[], revShareBeneficiaries: string[][], portions: number[][], maxRentDurations: number[], paymentTokens: PaymentToken[], allowedRenters?: string[][], options?: any): Promise<ContractTransaction>;
