...
})(NFTStandard || (NFTStandard = {})); // A RenftContractType represents a unique "style" of rental functionality:
//
...
})(RenftContractType || (RenftContractType = {}));

var AzraelVersion;

(function (AzraelVersion) {
  AzraelVersion["V0"] = "V0";
})(AzraelVersion || (AzraelVersion = {}));

var WhoopiVersion;

(function (WhoopiVersion) {
  WhoopiVersion["V0"] = "V0";
})(WhoopiVersion || (WhoopiVersion = {}));

var SylvesterVersion;

(function (SylvesterVersion) {
  SylvesterVersion["V0"] = "V0";
  SylvesterVersion["V1"] = "V1";
})(SylvesterVersion || (SylvesterVersion = {}));
...
var ETHEREUM_MAINNET_PAYMENT_TOKEN_RESOLVERS = (_ETHEREUM_MAINNET_PAY = {}, _ETHEREUM_MAINNET_PAY[PaymentToken.SENTINEL] = SENTINEL, _ETHEREUM_MAINNET_PAY[PaymentToken.WETH] = ETHEREUM_WETH, _ETHEREUM_MAINNET_PAY[PaymentToken.DAI] = ETHEREUM_DAI, _ETHEREUM_MAINNET_PAY[PaymentToken.USDC] = ETHEREUM_USDC, _ETHEREUM_MAINNET_PAY[PaymentToken.USDT] = ETHEREUM_USDT, _ETHEREUM_MAINNET_PAY[PaymentToken.TUSD] = ETHEREUM_TUSD, _ETHEREUM_MAINNET_PAY[PaymentToken.ACS] = SENTINEL, _ETHEREUM_MAINNET_PAY);
var POLYGON_MAINNET_PAYMENT_TOKEN_RESOLVERS = (_POLYGON_MAINNET_PAYM = {}, _POLYGON_MAINNET_PAYM[PaymentToken.SENTINEL] = SENTINEL, _POLYGON_MAINNET_PAYM[PaymentToken.WETH] = POLYGON_WETH, _POLYGON_MAINNET_PAYM[PaymentToken.DAI] = POLYGON_DAI, _POLYGON_MAINNET_PAYM[PaymentToken.USDC] = POLYGON_USDC, _POLYGON_MAINNET_PAYM[PaymentToken.USDT] = POLYGON_USDT, _POLYGON_MAINNET_PAYM[PaymentToken.TUSD] = POLYGON_TUSD, _POLYGON_MAINNET_PAYM[PaymentToken.ACS] = SENTINEL, _POLYGON_MAINNET_PAYM);
var AVALANCHE_FUJI_TESTNET_PAYMENT_TOKEN_RESOLVERS = (_AVALANCHE_FUJI_TESTN = {}, _AVALANCHE_FUJI_TESTN[PaymentToken.SENTINEL] = SENTINEL, _AVALANCHE_FUJI_TESTN[PaymentToken.WETH] = FUJI_WETH, _AVALANCHE_FUJI_TESTN[PaymentToken.DAI] = FUJI_DAI, _AVALANCHE_FUJI_TESTN[PaymentToken.USDC] = FUJI_USDC, _AVALANCHE_FUJI_TESTN[PaymentToken.USDT] = FUJI_USDT, _AVALANCHE_FUJI_TESTN[PaymentToken.TUSD] = FUJI_TUSD, _AVALANCHE_FUJI_TESTN[PaymentToken.ACS] = FUJI_ACS, _AVALANCHE_FUJI_TESTN);
var AVALANCHE_MAINNET_PAYMENT_TOKEN_RESOLVERS = (_AVALANCHE_MAINNET_PA = {}, _AVALANCHE_MAINNET_PA[PaymentToken.SENTINEL] = SENTINEL, _AVALANCHE_MAINNET_PA[PaymentToken.WETH] = AVALANCHE_WETH, _AVALANCHE_MAINNET_PA[PaymentToken.DAI] = AVALANCHE_DAI, _AVALANCHE_MAINNET_PA[PaymentToken.USDC] = AVALANCHE_USDC, _AVALANCHE_MAINNET_PA[PaymentToken.USDT] = AVALANCHE_USDT, _AVALANCHE_MAINNET_PA[PaymentToken.TUSD] = AVALANCHE_TUSD, _AVALANCHE_MAINNET_PA[PaymentToken.ACS] = AVALANCHE_ACS, _AVALANCHE_MAINNET_PA); // TODO: need to associate these with the resolver contract instance somehow

var NETWORK_RESOLVERS = (_NETWORK_RESOLVERS = {}, _NETWORK_RESOLVERS[EVMNetworkType.ETHEREUM_MAINNET] = ETHEREUM_MAINNET_PAYMENT_TOKEN_RESOLVERS, _NETWORK_RESOLVERS[EVMNetworkType.POLYGON_MAINNET] = POLYGON_MAINNET_PAYMENT_TOKEN_RESOLVERS, _NETWORK_RESOLVERS[EVMNetworkType.AVALANCHE_FUJI_TESTNET] = AVALANCHE_FUJI_TESTNET_PAYMENT_TOKEN_RESOLVERS, _NETWORK_RESOLVERS[EVMNetworkType.AVALANCHE_MAINNET] = AVALANCHE_MAINNET_PAYMENT_TOKEN_RESOLVERS, _NETWORK_RESOLVERS);
var ALL_NETWORKS = (_ALL_NETWORKS = {}, _ALL_NETWORKS[EVMNetworkType.ETHEREUM_MAINNET] = NETWORK_ETHEREUM_MAINNET, _ALL_NETWORKS[EVMNetworkType.POLYGON_MAINNET] = NETWORK_POLYGON_MAINNET, _ALL_NETWORKS[EVMNetworkType.AVALANCHE_FUJI_TESTNET] = NETWORK_AVALANCHE_FUJI_TESTNET, _ALL_NETWORKS[EVMNetworkType.AVALANCHE_MAINNET] = NETWORK_AVALANCHE_MAINNET, _ALL_NETWORKS); //// @deprecated
...
var toWhoopiScaledAmount = function toWhoopiScaledAmount(v, c, t) {
  if (t === PaymentToken.SENTINEL) throw new TypeError('Invalid payment token. Non-sentinels supported only.');
...
var createAzraelInterfaceVersionsThunk = function createAzraelInterfaceVersionsThunk(contract) {
  ...
  return _ref = {}, _ref[AzraelVersion.V0] = {
...
var createSylvesterInterfaceVersionsThunk = function createSylvesterInterfaceVersionsThunk(contract) {
  ...
  return _ref2 = {}, _ref2[SylvesterVersion.V0] = {
...
var createWhoopiInterfaceVersionsThunk = function createWhoopiInterfaceVersionsThunk(contract, network) {
  ...
  return _ref3 = {}, _ref3[WhoopiVersion.V0] = {
...
var createInterfaceVersions = function createInterfaceVersions(contract, network) {
  ...
  return _ref5 = {}, _ref5[RenftContractType.AZRAEL] = createAzraelInterfaceVersionsThunk(contract), _ref5[RenftContractType.SYLVESTER] = createSylvesterInterfaceVersionsThunk(contract), _ref5[RenftContractType.WHOOPI] = createWhoopiInterfaceVersionsThunk(contract, network), _ref5[RenftContractType.RESOLVER] = createResolverInterfaceVersionsThunk(), _ref5;
};
...
function getContractForDeployment(_ref3) {
  ...
  return new Contract(contractAddress, abi, signer != null ? signer : undefined);
}
