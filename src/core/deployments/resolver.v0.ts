...
export const DEPLOYMENT_RESOLVER_ETHEREUM_MAINNET_V0: DeploymentDefinition<
...
export const DEPLOYMENT_RESOLVER_ETHEREUM_GOERLI_TESTNET_V0: DeploymentDefinition<
  RenftContractType.RESOLVER,
  ResolverVersion.V0
> = {
  abi,
...
export const DEPLOYMENT_RESOLVER_POLYGON_MAINNET_V0: DeploymentDefinition<
  RenftContractType.RESOLVER,
  ResolverVersion.V0
> = {
  abi,
...
export const DEPLOYMENT_RESOLVER_AVALANCHE_FUJI_TESTNET_V0: DeploymentDefinition<
  RenftContractType.RESOLVER,
  ResolverVersion.V0
> = {
  abi,
...
export const DEPLOYMENT_RESOLVER_AVALANCHE_MAINNET_V0: DeploymentDefinition<
  RenftContractType.RESOLVER,
  ResolverVersion.V0
> = {
  abi,
