...
export const DEPLOYMENT_SYLVESTER_ETHEREUM_MAINNET_V0: DeploymentDefinition = {
  abi,
...
export const DEPLOYMENT_SYLVESTER_ETHEREUM_GOERLI_TESTNET_V0: DeploymentDefinition = {
  abi,
...
export const DEPLOYMENT_SYLVESTER_POLYGON_MAINNET_V0: DeploymentDefinition = {
  abi,
